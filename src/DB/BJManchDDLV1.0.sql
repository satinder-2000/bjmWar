...
CREATE TABLE IF NOT EXISTS `bjm`.`USER` (
  ...
  PRIMARY KEY (`ID`),
  INDEX `fk_USER_STATE1_idx` (`STATE_CODE` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bjm`.`SURVEY` (
  ...
  INDEX `fk_SURVEY_SURVEY_CATEGORY1_idx` (`SURVEY_CATEGORY_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bjm`.`FORUM` (
  ...
  `USER_ID` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_FORUM_FORUM_CATEGORY1_idx` (`FORUM_CATEGORY_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bjm`.`FORUM_COMMENT` (
  ...
  `USER_ID` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_FORUM_COMMENT_FORUM1_idx` (`FORUM_ID` ASC) VISIBLE,
  INDEX `fk_FORUM_COMMENT_USER1_idx` (`USER_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bjm`.`SURVEY_VOTE` (
  ...
  `USER_ID` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_SURVEY_VOTE_SURVEY1_idx` (`SURVEY_ID` ASC) VISIBLE,
  INDEX `fk_SURVEY_VOTE_USER1_idx` (`USER_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bjm`.`FORUM_ABUSE` (
  ...
  `USER_ID` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_FORUM_ABUSE_FORUM_COMMENT1_idx` (`FORUM_COMMENT_ID` ASC) VISIBLE,
  INDEX `fk_FORUM_ABUSE_USER1_idx` (`USER_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bjm`.`SURVEY_ABUSE` (
  ...
  `USER_ID` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_SURVEY_ABUSE_SURVEY_VOTE1_idx` (`SURVEY_VOTE_ID` ASC) VISIBLE,
  INDEX `fk_SURVEY_ABUSE_USER1_idx` (`USER_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bjm`.`BLOG_ABUSE` (
  ...
  `USER_ID` INT NOT NULL,
  PRIMARY KEY (`ID`),
  INDEX `fk_BLOG_ABUSE_BLOG_COMMENT1_idx` (`BLOG_COMMENT_ID` ASC) VISIBLE,
  INDEX `fk_BLOG_ABUSE_USER1_idx` (`USER_ID` ASC) VISIBLE,
